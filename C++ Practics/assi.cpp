...
int main() {
    Professor prof("John Doe", 45, "123 University St", "P001", "Computer Science");
    Course course("CS101", "Introduction to Programming", 3, &prof);

    Student student1("Alice Smith", 20, "456 College Ave", "S001", "Computer Science");
    Student student2("Bob Johnson", 22, "789 Campus Rd", "S002", "Mathematics");
